...
;//! \htmlinclude getPose.msg.html

(cl:defclass <getPose> (roslisp-msg-protocol:ros-message)
  ((result
    :reader result
    :initarg :result
    :type cl:integer
...
(cl:defclass getPose (<getPose>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <getPose>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'getPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot-msg:<getPose> is deprecated: use dobot-msg:getPose instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <getPose>))
...
(cl:defmethod jointAngle-val ((m <getPose>))
  ...
  (jointAngle m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <getPose>) ostream)
  "Serializes a message object of type '<getPose>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <getPose>) istream)
  "Deserializes a message object of type '<getPose>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<getPose>)))
  "Returns string type for a message object of type '<getPose>"
  "dobot/getPose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'getPose)))
  "Returns string type for a message object of type 'getPose"
  "dobot/getPose")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<getPose>)))
  "Returns md5sum for a message object of type '<getPose>"
  "d4de75e47bb9a51cbb33e89d50edf04f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'getPose)))
  "Returns md5sum for a message object of type 'getPose"
  "d4de75e47bb9a51cbb33e89d50edf04f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<getPose>)))
  "Returns full string definition for message of type '<getPose>"
  (cl:format cl:nil "int32 result~%float32 x~%float32 y~%float32 z~%float32 r~%float32[] jointAngle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'getPose)))
  "Returns full string definition for message of type 'getPose"
  (cl:format cl:nil "int32 result~%float32 x~%float32 y~%float32 z~%float32 r~%float32[] jointAngle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <getPose>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <getPose>))
